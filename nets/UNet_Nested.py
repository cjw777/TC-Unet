...
class ASPP(nn.Module):
    def __init__(self, ch_in, ch_out, rate=[1, 3, 5]):
...
class NestedUNet(nn.Module):
    def __init__(self, num_classes, input_channels=3, deep_supervision=False, **kwargs):
        ...
        self.conv4_0 = ASPP(nb_filter[3], nb_filter[4])
        ...
        self.conv3_1 = ASPP(nb_filter[3]+nb_filter[4], nb_filter[3])

        self.conv0_2 = VGGBlock(nb_filter[0]*2+nb_filter[1], nb_filter[0], nb_filter[0])
        self.conv1_2 = VGGBlock(nb_filter[1]*2+nb_filter[2], nb_filter[1], nb_filter[1])
        self.conv2_2 = ASPP(nb_filter[2]*2+nb_filter[3], nb_filter[2])


        self.conv0_3 = VGGBlock(nb_filter[0]*3+nb_filter[1], nb_filter[0], nb_filter[0])
        self.conv1_3 = ASPP(nb_filter[1]*3+nb_filter[2], nb_filter[1])
    ...
    def forward(self, input):
        ...
        # x0_2 = self.ca2(x0_2) * x0_0
        # x0_2 = self.sa2(x0_2) * x0_0
        # print(x0_2.shape)
        ...
        # x0_3 = self.ca3(x0_3) * x0_0
        # x0_3 = self.sa3(x0_3) * x0_0
        # print(x0_3.shape)
        ...
        # x0_4 = self.ca4(x0_4) * x0_0
        # x0_4 = self.sa4(x0_4) * x0_0
        # print(x0_4.shape)
        
        a = [x0_0,x1_0,x2_0,x3_0,x4_0]
        if self.deep_supervision:
