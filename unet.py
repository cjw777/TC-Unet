...
from nets.Double_UNet_Nesed import Double_UNetNesed as unet
...
class Unet(object):
    _defaults = {
        "model_path"        : '/home/huawei/cjw_workdir/unet++_first_double/logs/Epoch97-Total_Loss0.1123-Val_Loss0.1581.pth',
    ...
    #---------------------------------------------------#
    def generate(self):
        self.net = unet(num_classes=self.num_classes, input_channels=self.model_image_size[-1]).eval()
